...
def supportVectorMachine(request):
    ...
    saveTrainedModel(classifier, "support_vector_machine", "scikit-learn")
    ...
    outputImageUrls = [
        os.path.join(outputImageDir, 'supportVectorMachineTrainGraph.jpg'),
        os.path.join(outputImageDir, 'supportVectorMachineTestGraph.jpg')
    ]
