...
def logisticRegression(request):
    ...
    saveTrainedModel(classifier, "logistic_regression", "scikit-learn")
    ...
    outputImageUrls = [
        os.path.join(outputImageDir, 'logisticRegressionTrainGraph.jpg'),
        os.path.join(outputImageDir, 'logisticRegressionTestGraph.jpg')
    ]
