...
def naiveBayes(request, validated_params=None, user_id=None, session_version=None):
    data = request.json
    ...
    model_path = saveTrainedModel(classifier, "naive_bayes", "scikit-learn", user_id=user_id, version=session_version)
    ...
    outputImageUrls = [
        os.path.join(img_dir, 'naiveBayesTrainGraph.jpg'),
        os.path.join(img_dir, 'naiveBayesTestGraph.jpg')
    ]
