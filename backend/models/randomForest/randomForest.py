...
def randomForest(request):
    ...
    saveTrainedModel(classifier, "random_forest", "scikit-learn") 
    ...
    outputImageUrls = [
        os.path.join(outputImageDir, 'randomForestTrainGraph.jpg'),
        os.path.join(outputImageDir, 'randomForestTestGraph.jpg')
    ]
