...
def decisionTree(request):
    ...
    saveTrainedModel(classifier, "decision_tree", "scikit-learn") 
    ...
    outputImageUrls = [
        os.path.join(outputImageDir, 'decisionTreeTrainGraph.jpg'),
        os.path.join(outputImageDir, 'decisionTreeTestGraph.jpg')
    ]
