...
datasets_routes = Blueprint('datasets_routes', __name__)

from auth.auth_middleware import token_required


@datasets_routes.route('/upload', methods=['POST'])
@token_required
...
@datasets_routes.route('/datasets/default', methods=['GET'])
...
@datasets_routes.route('/datasets/<dataset_id>', methods=['DELETE'])
@token_required
...
@datasets_routes.route('/datasets/preprocess', methods=['POST'])
@token_required
...
@datasets_routes.route('/datasets/<dataset_id>/profile', methods=['GET'])
@token_required
...
@datasets_routes.route('/datasets/diff', methods=['POST'])
@token_required
...
@datasets_routes.route('/datasets/<dataset_id>/preview', methods=['GET'])
@token_required
...
@datasets_routes.route('/datasets/versions/<filename>', methods=['GET'])
@token_required
...
@datasets_routes.route('/datasets/<dataset_id>/folder-images', methods=['GET'])
@token_required
...
@datasets_routes.route('/datasets/save-annotations', methods=['POST'])
@token_required
