...
const FinetuneBERT = () => {
    ...
    return (
        <div className="model-container">
            ...
            <BERTForm onSubmit={startTraining} disabled={training} />
...
const BERTForm = ({ onSubmit, disabled }) => {
            ...
            <div className="form-section">
                ...
                <div className="form-row">
                    <div className="form-group">
                        ...
                        <input type="text" value={filename} onChange={e => setFilename(e.target.value)} placeholder="e.g. reviews.csv" required />
                    </div>
                    <div className="form-group">
                        <label>Text Column</label>
                        <input type="text" value={textColumn} onChange={e => setTextColumn(e.target.value)} placeholder="Column with text" />
                    </div>
                    <div className="form-group">
                        <label>Label Column</label>
                        <input type="text" value={labelColumn} onChange={e => setLabelColumn(e.target.value)} placeholder="Column with labels" />
                    </div>
                </div>
            </div>
