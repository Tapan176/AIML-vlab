...
export default function LogisticRegression() {
    ...
    const { train, loading, error, results: freshResults } = useModelTrain('/logistic-regression');
    ...
    return (
        <div className="model-page">
            ...
            <ImageCarousel images={results?.images || []} modelName="logistic_regression" />
            {results && (
                <div className="download-section">
                    {(results.trained_model_drive_id || !results.session_id) && (
                        <DownloadTrainedModel selectedModel="logistic_regression" extension=".pkl" sessionId={results.session_id} label="Download" />
                    )}
